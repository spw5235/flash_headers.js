...
window.Typekit.config = {
    "a": "273698",
    "c": [".tk-proxima-nova", "\"proxima-nova\",sans-serif", ".tk-freight-text-pro", "\"freight-text-pro\",sans-serif"],
    "f": "//use.typekit.net/c/c01614/1w;freight-text-pro,2,WHZ:N:i4,WHc:N:i7,WHY:N:n4,WHb:N:n7;proxima-nova,2,W0W:N:i4,W0Z:N:i7,W0V:N:n4,W0Y:N:n7/{format}{/extras*}?",
    "fi": [176, 140, 139, 175, 13467, 13465, 13466, 13464],
    "fn": ["freight-text-pro", ["i4", "i7", "n4", "n7"], "proxima-nova", ["i4", "i7", "n4", "n7"]],
    "ht": "tk",
    "js": "1.7.0",
    "k": "//use.typekit.net/{id}.js",
    "kt": "aiw8ftx",
    "p": "//p.typekit.net/p.gif?s=1&k=aiw8ftx&ht=tk&h={host}&f=176.140.139.175.13467.13465.13466.13464&a=273698&_={_}",
    "ps": 1,
    "w": "aiw8ftx"
};
...
(function(window, document, undefined) {
    ...
    ka.prototype.parse = function() {
        ...
        if ( - 1 != this.e.indexOf("MSIE")||-1 != this.e.indexOf("Trident/")) {
            a = A(this);
            var b = B(this), c = y(b), d = k, e = k, f = k, g = k, h = C(this.e, /Trident\/([\d\w\.]+)/, 1), p = F(this.R), d =- 1 != this.e.indexOf("MSIE") ? C(this.e, /MSIE ([\d\w\.]+)/, 1) : C(this.e, /rv:([\d\w\.]+)/, 1), e = y(d);
            ...
            a: if (a = "Unknown", b =
        C(this.e, /Presto\/([\d\w\.]+)/, 1), c = y(b), d = B(this), e = y(d), f = F(this.R), c.g !== k ? a = "Presto" : ( - 1 != this.e.indexOf("Gecko") && (a = "Gecko"), b = C(this.e, /rv:([^\)]+)/, 1), c = y(b)), - 1 != this.e.indexOf("Opera Mini/"))
            g = C(this.e, /Opera Mini\/([\d\.]+)/, 1), h = y(g), a = new z("OperaMini", h, g, a, c, b, A(this), e, d, f, new u(l, l, l));
        else {
            ...
            / OPR\ / [\d.] + /.test(this.e)?a=oa(this):/AppleWeb(K | k)it / .test(this.e) ? a = oa(this) : - 1 != this.e.indexOf("Gecko") ? (a = "Unknown", b = new v, c = "Unknown", d = B(this), e = y(d), f = l, - 1 != this.e.indexOf("Firefox") ? (a = "Firefox", c = C(this.e, /Firefox\/([\d\w\.]+)/, 1), b = y(c), f = 3 <= b.g && 5 <= b.o) : - 1 != this.e.indexOf("Mozilla") && (a = "Mozilla"), g = C(this.e, /rv:([^\)]+)/, 1), h = y(g), f || (f = 1 < h.g ||
    ...
    function B(a) {
        ...
        if (b || (b = C(a.e, /Windows Phone( OS)? ([^;)]+)/, 2)) || (b = C(a.e, /(iPhone )?OS ([\d_]+)/, 2)))
            return b;
    ...
    function oa(a) {
        var b = A(a), c = B(a), d = y(c), e = C(a.e, /AppleWeb(?:K|k)it\/([\d\.\+]+)/, 1), f = y(e), g = "Unknown", h = new v, p = "Unknown", M = l;
    ...
    function ua(a, b, c, d, e, f, g, h) {
        ...
        ta(a);
        for (var p in L)
            L.hasOwnProperty(p) && (sa(a, new J(L[p], H(this.C))), this.P[L[p]] = a.D.offsetWidth);
        a.remove()
    }
    var L = {
        bb: "serif",
    ...
    X.prototype.load = function(a, b, c) {
        if (this.t) {
            for (var d = Xa[this.t] || new Ra(Ta), e = 0; e < this.v.length; e++) {
                for (var f = this.v[e], g = this.t, h = d, p = [], M = f.L.split(",")[0].replace(/"|'/g, ""), E = f.H(), R = p, D = void 0, I = [], Sa = {}, ma = 0; ma < E.length; ma++)
                    D = E[ma], 0 < D.length&&!Sa[D] && (Sa[D] = j, I.push(D));
                E = I;
                h = h.va ? h.va(M, E, R) : E;
                f.oa[g] = h;
                f.na[g] = p
            ...
            if (a) {
                var na = this, ob = this.t;
                ga(this.j, function() {
                    for (var c = 0; c < na.v.length; c++)
                        na.v[c].fa(a, ob, b && c == na.v.length - 1)
                })
            }
        }
    };
    ...
    X.prototype.performOptionalActions = function() {
        if (this.ca) {
            ...
            ga(this.j, function() {
                var d = a.ca;
                if (d.ua) {
                    var e = window.__adobewebfontsappname__, e = e ? e.toString().substr(0, 20): "", d = d.ua.h(t(c), {
    ...
    function Za(a, b) {
        if (0 != a.u.length) {
            ...
            for (var c = new qa(a.j, a.n, b), d = l, e = 0; e < a.u.length; e++)
            ...
            if (d) {
                ...
                for (var f = new N(a.e, a.j, c, b.timeout), c = function(a, b, c) {
                    for (var d = [], e = 0; e < a.length; e += 1) {
                        var R = a[e];
                        if (b[R])
                            for (var D = b[R], I = 0; I < D.length; I += 1)
                                d.push(new J(R, D[I]));
                        else 
                            d.push(new J(R))
                    }
                    ...
                    e = a.u[d], e.supportsConfiguredBrowser() && (e.load(c, d == a.u.length -
    ...
    if (!window.Typekit.load) {
        ...
        eb.k && (fb = new P(eb.k));
        var gb = new Ya(fb, new fa(window), db, document.documentElement), hb = new $a(window);
    ...
    var ib, jb = k, kb = k, lb = k, mb, Y, Z, O = window.Typekit.config || {};
    ...
    var i;
    if (O.fn)
        for (i = 0; i < O.fn.length; i += 2)
            Z.v.push(new Da(O.fn[i], O.fn[i + 1]));
    if (O.c)
        for (i = 0; i < O.c.length; i += 2)
            Z.Q.push(new za);
    var nb;
    if (nb = hb)
        nb=!!hb.I.__webfonttypekitmodule__;
